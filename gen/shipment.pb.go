...
type Shipment struct {
	...
	DriverUnit      string                 `protobuf:"bytes,7,opt,name=driver_unit,json=driverUnit,proto3" json:"driver_unit,omitempty"`
...
func (x *Shipment) GetDriverUnit() string {
	if x != nil {
		return x.DriverUnit
	}
	return ""
...
type CreateShipmentRequest struct {
	...
	DriverUnit      string                 `protobuf:"bytes,5,opt,name=driver_unit,json=driverUnit,proto3" json:"driver_unit,omitempty"`
...
func (x *CreateShipmentRequest) GetDriverUnit() string {
	if x != nil {
		return x.DriverUnit
	}
	return ""
...
const file_shipment_proto_rawDesc = "" +
	"\n" +
	"\x0eshipment.proto\x12\vshipment.v1\"\xf3\x02\n" +
	"\bShipment\x12\x0e\n" +
	...
	"shipmentId\x123\n" +
	"\x06status\x18\x03 \x01(\x0e2\x1b.shipment.v1.ShipmentStatusR\x06status\x12\x12\n" +
	...
	"\bshipment\x18\x01 \x01(\v2\x15.shipment.v1.ShipmentR\bshipment\"\x83\x01\n" +
	"\x17AddShipmentEventRequest\x12\x1f\n" +
	"\vshipment_id\x18\x01 \x01(\tR\n" +
	"shipmentId\x123\n" +
	"\x06status\x18\x02 \x01(\x0e2\x1b.shipment.v1.ShipmentStatusR\x06status\x12\x12\n" +
	...
	"\x19SHIPMENT_STATUS_CANCELLED\x10\x052\x86\x03\n" +
	...
	"\x12GetShipmentHistory\x12&.shipment.v1.GetShipmentHistoryRequest\x1a'.shipment.v1.GetShipmentHistoryResponseB:Z8github.com/yourusername/shipment-service/gen/shipment/v1b\x06proto3"
...
var file_shipment_proto_depIdxs = []int32{
	...
	0,  // 1: shipment.v1.ShipmentEvent.status:type_name -> shipment.v1.ShipmentStatus
	1,  // 2: shipment.v1.CreateShipmentResponse.shipment:type_name -> shipment.v1.Shipment
	1,  // 3: shipment.v1.GetShipmentResponse.shipment:type_name -> shipment.v1.Shipment
	0,  // 4: shipment.v1.AddShipmentEventRequest.status:type_name -> shipment.v1.ShipmentStatus
	2,  // 5: shipment.v1.AddShipmentEventResponse.event:type_name -> shipment.v1.ShipmentEvent
	2,  // 6: shipment.v1.GetShipmentHistoryResponse.events:type_name -> shipment.v1.ShipmentEvent
	3,  // 7: shipment.v1.ShipmentService.CreateShipment:input_type -> shipment.v1.CreateShipmentRequest
	5,  // 8: shipment.v1.ShipmentService.GetShipment:input_type -> shipment.v1.GetShipmentRequest
	7,  // 9: shipment.v1.ShipmentService.AddShipmentEvent:input_type -> shipment.v1.AddShipmentEventRequest
	9,  // 10: shipment.v1.ShipmentService.GetShipmentHistory:input_type -> shipment.v1.GetShipmentHistoryRequest
	4,  // 11: shipment.v1.ShipmentService.CreateShipment:output_type -> shipment.v1.CreateShipmentResponse
	6,  // 12: shipment.v1.ShipmentService.GetShipment:output_type -> shipment.v1.GetShipmentResponse
	8,  // 13: shipment.v1.ShipmentService.AddShipmentEvent:output_type -> shipment.v1.AddShipmentEventResponse
	10, // 14: shipment.v1.ShipmentService.GetShipmentHistory:output_type -> shipment.v1.GetShipmentHistoryResponse
